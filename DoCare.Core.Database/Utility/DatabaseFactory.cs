...
using System.Text;
using DoCare.Core.Database.Imp.Command.MsSql;
using DoCare.Core.Database.Imp.Command.MySql;
using DoCare.Core.Database.Imp.Command.Oracle;
using DoCare.Core.Database.Imp.Operate;
using DoCare.Core.Database.Imp.Operate.MySqlOperate;
using DoCare.Core.Database.Imp.Operate.OracleOperate;
using DoCare.Core.Database.Imp.Operate.SqlOperate;
using DoCare.Core.Database.Interface.Command;
using DoCare.Core.Database.Interface.Operate;
using MySql.Data.MySqlClient;
using Oracle.ManagedDataAccess.Client;

namespace DoCare.Core.Database.Utility
{
